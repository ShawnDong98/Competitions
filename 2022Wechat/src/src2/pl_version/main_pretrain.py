...
parser.add_argument("--train_dir", type=str, default="/home/datasets/2022WeChat/data/zip_feats/unlabeled")
parser.add_argument("--val_dir", type=str, default="/home/datasets/2022WeChat/data/zip_feats/labeled")
parser.add_argument("--test_dir", type=str, default="/home/datasets/2022WeChat/data/zip_feats/test_b")
parser.add_argument("--train_json", type=str, default="/home/datasets/2022WeChat/data/annotations/unlabeled.json")
parser.add_argument("--val_json", type=str, default="/home/datasets/2022WeChat/data/annotations/labeled.json")
...
parser.add_argument("--tasks", type=list, default=['mlm'])
parser.add_argument("--checkpoints_dir", type=str,default="checkpoints_pretrained")
...
class LitDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        if stage == "fit" or stage is None:
            self.train_dataset = WeChatDataset(
            ...
            self.val_dataset = WeChatDataset(
                model_path = self.args.model_path,
                data_dir = self.args.val_dir,
                get_title=True,
                get_asr=True,
                get_ocr=True,
                get_frame=True,
                label_json=self.args.val_json, 
                get_vid=True,
                get_category=False,
                text_maxlen=self.args.text_maxlen, 
                frame_maxlen=self.args.frame_maxlen,
...
class LitModule(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        res = self._step(batch, "val")
        return res

    def validation_epoch_end(self, validation_step_outputs):
        if 'pred' in validation_step_outputs[0] and 'target' in validation_step_outputs[0]:
            ...
            if results['mean_f1'] > self.best_mean_f1:
                self.best_mean_f1 = results['mean_f1']
                with self.ema.average_parameters():
                    torch.save(self.state_dict(), os.path.join(self.args.checkpoints_dir, "best_pth.pth"))
    ...
    def _step(self, batch, step):
        ...
        if 'mlm' in tasks:
            ...
            loss += masked_lm_loss
            log_dict[f'{step}_mlm_loss'] = masked_lm_loss
        ...
        if 'mfm' in tasks:
            ...
            log_dict[f'{step}_mfm_loss'] = masked_vm_loss
        ...
        if 'cls' in tasks:
            ...
            with torch.no_grad():
                ...
                res['pred'] = pred
            log_dict[f'{step}_cls_loss'] = cls_loss
            log_dict[f'{step}_acc'] = accuracy
...
def main():
    ...
    trainer = pl.Trainer(
            ...
            precision=16,
            limit_train_batches=0.001 if args.DEBUG else 1.0,
            limit_val_batches=0.01 if args.DEBUG else 1.0,
            # logger=wandb_logger,
            # val_check_interval=10 if args.DEBUG else 500,
